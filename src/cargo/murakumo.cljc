...
(defn collection
  [name]
  (str "com.etzhayyim.cargo." name))

(def cell-specs {
  :getbl {:legacy-cell "com-etzhayyim-apps-cargo-manifest-getBl"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getbl")]
     :required-gates common-gates
     :trigger "manifest cell getbl"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :listbls {:legacy-cell "com-etzhayyim-apps-cargo-manifest-listBls"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listbls")]
     :required-gates common-gates
     :trigger "manifest cell listbls"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :trackcontainer {:legacy-cell "com-etzhayyim-apps-cargo-manifest-trackContainer"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "trackcontainer")]
     :required-gates common-gates
     :trigger "manifest cell trackcontainer"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :listcontainers {:legacy-cell "com-etzhayyim-apps-cargo-manifest-listContainers"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listcontainers")]
     :required-gates common-gates
     :trigger "manifest cell listcontainers"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :getvoyagemanifest {:legacy-cell "com-etzhayyim-apps-cargo-manifest-getVoyageManifest"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getvoyagemanifest")]
     :required-gates common-gates
     :trigger "manifest cell getvoyagemanifest"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :health {:legacy-cell "com-etzhayyim-apps-cargo-health"
     :phase :event
     :murakumo-node "reuben"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :get {:legacy-cell "com-etzhayyim-apps-cargo-coverage-get"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :billoflading {:legacy-cell "com-etzhayyim-apps-cargo-billOfLading"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "billoflading")]
     :required-gates common-gates
     :trigger "manifest cell billoflading"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :cargoitem {:legacy-cell "com-etzhayyim-apps-cargo-cargoItem"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "cargoitem")]
     :required-gates common-gates
     :trigger "manifest cell cargoitem"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :container {:legacy-cell "com-etzhayyim-apps-cargo-container"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "container")]
     :required-gates common-gates
     :trigger "manifest cell container"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :dangerousgoods {:legacy-cell "com-etzhayyim-apps-cargo-dangerousGoods"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "dangerousgoods")]
     :required-gates common-gates
     :trigger "manifest cell dangerousgoods"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
